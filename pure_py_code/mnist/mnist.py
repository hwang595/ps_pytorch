...
def read_data_sets(train_dir,
  ...
  valid_labels_tmp[numpy.arange(len(valid_labels_tmp)), validation_labels] += 1


  #train = DataSet(train_images, train_labels, dtype=dtype, reshape=reshape)
  train = DataSet(train_images, train_labels_tmp, dtype=dtype, reshape=reshape)

  validation = DataSet(validation_images, valid_labels_tmp, dtype=dtype, reshape=reshape)

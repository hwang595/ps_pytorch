...
if __name__ == "__main__":
	...
	train_loader_mnist = torch.utils.data.DataLoader(training_set, batch_size=args.batch_size, shuffle=True)
	...
	train_loader_cifar10 = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size,
	                                          shuffle=True)
